...
class silo_layers():
    ...
    def get_200silo_layers_from_orders(orders: str):
        ...
        df['Efterfølgende kontraktnummer'] = df.apply(lambda x: silo_layers.get_silo_layer(
                                                x.Silo, 
                                                x.LR_DATO, 
                                                x.Kontraktnummer, 
                                                x.Modtagelse, 
        ...
        df['Efterfølgende modtagelse'] = df.apply(lambda x: silo_layers.get_silo_layer(
                                                x.Silo, 
                                                x.LR_DATO, 
                                                x.Kontraktnummer, 
                                                x.Modtagelse, 
        ...
        df['Foregående kontraktnummer'] = df.apply(lambda x: silo_layers.get_silo_layer(
                                                x.Silo, 
                                                x.LR_DATO, 
                                                x.Kontraktnummer, 
                                                x.Modtagelse, 
        ...
        df['Foregående modtagelse'] = df.apply(lambda x: silo_layers.get_silo_layer(
                                                x.Silo, 
                                                x.LR_DATO, 
                                                x.Kontraktnummer, 
                                                x.Modtagelse, 
